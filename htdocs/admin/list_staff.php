                                            ...
                                            <?php 
                                               $all_users = User::find_all_access("b");
                                                foreach($all_users as $user) {
                                                    ...
                                                    echo "<td><a type='button' class='btn btn-danger' href='delete_customer.php?gg={$user->id}'>Delete staff</a></td>";
                                                    echo "<td><a type='button' class='btn btn-success' href='#.php?gg={$user->id}'>View profile</a></td></tr>";
