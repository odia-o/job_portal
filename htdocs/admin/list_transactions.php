                                ...
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <?php 
                                               $all_ts = Transaction::find_all();
//                                            var_dump($all_ts);
//                                            exit();
                                                foreach($all_ts as $t) {
                                                    $user = User::find_by_id($t->user_id);
                                                    $add = Addresses::find_by_id($t->address_id);
                                                    echo "<tr><td>". $user->first_name. " ". $user->last_name."</td>";
                                                    echo "<td>".$add->house_number. ", ".$add->street_name.", ".$add->city.", ".$add->state. ".</td>";
                                                    echo "<td>". $t->amount_paid. "</td>";
                                                    echo "<td>". $t->unit. "</td>";
                                                    echo "<td>****".$t->code_generated."***</td></tr>";
