                                            ...
                                            <?php 
                                               $all_js = Jobs::find_by_job_id($user->id);
                                                ...
                                                foreach($all_js as $js) {    
                                                    ...
                                                    echo "<td><a type='button' class='btn btn-success' href='view_profile.php?gg={$cs->id}'>Update</a></td>";
...
//    exit();
                                                foreach($all_users as $user) {
                                                    ...
                                                    echo "<td><a type='button' class='btn btn-danger' href='delete_user.php?gg={$cs->id}'>Delete Company</a></td></tr>";
...
//    exit();
                                                foreach($all_cs as $cs) {
                                                    ...
                                                    echo "<td>". $cs->num. ", ".$cs->str_name.", ".$cs->city.", ".$cs->state."</td>";
                                                    echo "<td>". $cs->email. "</td>";
                                                    echo "<td><a type='button' class='btn btn-success' href='view_profile.php?gg={$cs->id}'>View Profile</a></td>";
                                                    echo "<td><a type='button' class='btn btn-danger' href='delete_company.php?gg={$cs->id}'>Delete Company</a></td></tr>";
...
//    exit();
                                                foreach($all_js as $js) {
                                                    ...
                                                    echo "<td>". $js->description. "</td>";
                                                    echo "<td>". $cs->name. "</td>";
                                                    echo "<td><a href='#' class='btn btn-success'>Apply</a></td>";
                                                    echo "</tr>";
				...
				<p class="form-row">
					<input type="submit" class="button border fw margin-top-10" name="submit2" value="Update" />
                                                        ...
                                                        <form method="post" action="">
                                                            <input type="file" name="cv" placeholder="Browse" /><button type="submit" name="" value="Upload CV"></button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
