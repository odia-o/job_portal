            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="register.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Register new staff</p></a></li>
                    </ul> 
                                            ...
                                            <?php 
                                               $all_users = User::find_all_access("c");
                                                foreach($all_users as $user) {
                                                    ...
                                                    echo "<td><a type='button' class='btn btn-danger' href='delete_address.php?gg={$user->id}'>Delete Customer</a></td></tr>";
