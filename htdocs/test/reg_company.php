...
if(filter_has_var(INPUT_POST, 'submit')) {
                ...
                $user->num = $_POST['exampleInputQuantity'];
                $user->str_name = $_POST['exampleInputProductName'];
                $user->city = $_POST['exampleInputProductId'];
                                ...
                                <div class="panel-body">
                                    <div id="rootwizard">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab1" data-toggle="tab"><i class="fa fa-user m-r-xs"></i>Company</a></li>
                                            <li role="presentation"><a href="#tab2" data-toggle="tab"><i class="fa fa-truck m-r-xs"></i>Address Info</a></li>
                                            <li role="presentation"><a href="#tab3" data-toggle="tab"><i class="fa fa-truck m-r-xs"></i>About</a></li>
                                            ...
                                            <div class="tab-content">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row">
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control" name="exampleInputName" id="exampleInputName" placeholder="First Name" value="<?php echo $c->name; ?>">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="exampleInputEmail">Email address</label>
                                                                    <input type="email" class="form-control" name="exampleInputEmail" id="exampleInputEmail" placeholder="Enter email" value="<?php echo $c->email; ?>">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                ...
                                                <div class="tab-pane fade" id="tab2">
                                                        ...
                                                        <div class="col-md-9">
                                                             <div class="row">
                                                            <div class="form-group col-md-12">
                                                                <label for="exampleInputQuantity">Building Number</label>
                                                ...
                                                <div class="tab-pane fade" id="tab3">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group col-md-12">
                                                                <label for="exampleInputCard">Postal Code</label>
                                                                <div class="row">
                                                                    <div class="col-md-8">
                                                                        <input type="text" class="form-control" name="exampleInputCard" id="exampleInputCard" placeholder="Postal">
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control col-md-4" name="exampleInputSecurity" id="exampleInputSecurity" placeholder="Phone Number">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                                <label for="exampleInputHolder">Vision</label>
                                                                <input type="text" class="form-control" name="exampleInputHolder" id="exampleInputHolder" placeholder="Vison">
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                                <label for="exampleInputExpiration">Type Of Clients</label>
                                                                <input type="text" class="form-control" name="exampleInputExpiration" id="exampleInputExpiration" placeholder="Type of Clients">
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                                <label for="exampleInputCsv">Staff size</label>
                                                                <input type="text" class="form-control" name="exampleInputCsv" id="exampleInputCsv" placeholder="Staff Size">
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                                <label class="f-s-12">By pressing Next You will Agree to the <a href="#">Terms & Conditions</a></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
