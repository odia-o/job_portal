...
<div class="container">
	<div class="sixteen columns">
		...
		<nav id="navigation" class="menu">
            <div id="logo">
			<h1><a href="index.html"><img src="images/logggz.jpg" alt="Joblink" height="5px" width="5px"/></a></h1>
...
<div class="container">
	<div class="sixteen columns">
		...
		<ul id="popular-categories" role="tablist">
			<li role="presentation"><a href="#tab1" role="tab" data-toggle="tab"><i class="ln  ln-icon-Bar-Chart"></i> Accounting / Finance</a></li>
			<li><a href="#tab2" role="tab"><i class="ln ln-icon-Car"></i> Automotive Jobs</a></li>
			<li><a href="#tab3" role="tab"><i class="ln ln-icon-Worker"></i> Construction / Facilities</a></li>
			<li><a href="#tab4" role="tab"><i class="ln ln-icon-Student-Female"></i> Education Training</a></li>
			<li><a href="#tab5" role="tab"><i class="ln  ln-icon-Medical-Sign"></i> Healthcare</a></li>
			<li><a href="#tab6" role="tab"><i class="ln  ln-icon-Plates"></i> Restaurant / Food Service</a></li>
			<li><a href="#tab7" role="tab"><i class="ln  ln-icon-Globe"></i> Transportation / Logistics</a></li>
			<li><a href="#tab8" role="tab"><i class="ln  ln-icon-Laptop-3"></i> Telecommunications</a></li>
		</ul>
        ...
        <div class="tab-content" id="tab1">
              <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Accounting / Finance</h4>
                                </div>
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <?php 
                                               $all_js = Jobs::find_all_cat("Accounting / Finance");
//    var_dump($all_cs);
//    exit();
                                                foreach($all_js as $js) {
                                                    $cs = Company::find_by_id($js->company_id);
        ...
        <div class="tab-content" id="tab2" style="display: none;">
            <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Automotive Jobs</h4>
                                </div>
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <?php 
                                               $all_js = Jobs::find_all_cat("Automotive Jobs");
//    var_dump($all_cs);
//    exit();
                                                foreach($all_js as $js) {
                                                    $cs = Company::find_by_id($js->company_id);
        ...
        <div class="tab-content" id="tab3" style="display: none;">
            <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Construction / Facilities</h4>
                                </div>
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <?php 
                                               $all_js = Jobs::find_all_cat("Construction / Facilities");
//    var_dump($all_cs);
//    exit();
                                                foreach($all_js as $js) {
                                                    $cs = Company::find_by_id($js->company_id);
        ...
        <div class="tab-content" id="tab4" style="display: none;">
            <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Education Training</h4>
                                </div>
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <?php 
                                               $all_js = Jobs::find_all_cat("Education Training");
//    var_dump($all_cs);
//    exit();
                                                foreach($all_js as $js) {
                                                    $cs = Company::find_by_id($js->company_id);
        ...
        <div class="tab-content" id="tab5" style="display: none;">
            <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Healthcare</h4>
                                </div>
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <?php 
                                               $all_js = Jobs::find_all_cat("Healthcare");
//    var_dump($all_cs);
//    exit();
                                                foreach($all_js as $js) {
                                                    $cs = Company::find_by_id($js->company_id);
        ...
        <div class="tab-content" id="tab6" style="display: none;">
            <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Restaurant / Food Service</h4>
                                </div>
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <?php 
                                               $all_js = Jobs::find_all_cat("Restaurant / Food Service");
//    var_dump($all_cs);
//    exit();
                                                foreach($all_js as $js) {
                                                    $cs = Company::find_by_id($js->company_id);
        ...
        <div class="tab-content" id="tab7" style="display: none;">
            <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Transportation / Logistics</h4>
                                </div>
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <?php 
                                               $all_js = Jobs::find_all_cat("Transportation / Logistics");
//    var_dump($all_cs);
//    exit();
                                                foreach($all_js as $js) {
                                                    $cs = Company::find_by_id($js->company_id);
        ...
        <div class="tab-content" id="tab8" style="display: none;">
            <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Telecommunications</h4>
                                </div>
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <?php 
                                               $all_js = Jobs::find_all_cat("Telecommunications");
//    var_dump($all_cs);
//    exit();
                                                foreach($all_js as $js) {
                                                    $cs = Company::find_by_id($js->company_id);
